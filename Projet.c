...
void chiffrementAES()
{
    ...
    char cle192[24] = "7o3jk4rhf32k1k5p5oijb34j";
    char cle256[32] = "7o3jk4rhf32k1k5p5oijb34jk150ob23";
    printf("\n--> Sélectionner la taille de clé <--\n");
    printf("1.128 bits\n");
    printf("2.192 bits\n");
    printf("3.256 bits\n");
    printf("Votre choix: ");
    ...
    {
    case 1:
        chiffrerFichierAES(cle128, 10);
        break;
    case 2:
        chiffrerFichierAES(cle192, 12);
        break;
    case 3:
        chiffrerFichierAES(cle256, 14);
        break;
    default:
...
void dechiffrementAES()
{
    ...
    {
    case 1:
        dechiffrerFichierAES(cle128, 10);
        break;
    case 2:
        dechiffrerFichierAES(cle192, 12);
        break;
    case 3:
        dechiffrerFichierAES(cle256, 14);
        break;
    default:
        printf("Erreur, taille de clé incorrecte !\n\n");
        break;
